...
namespace PLCompliant.STEP_7
{
    ...
    public class IsoTcpMessageFactory
    {
        #region methods
        /// <summary>
        /// Message to initiate connection request on TSAP  02 00
        /// </summary>
        ...
        /// <summary>
        /// Message to initiate connection request on TSAP 01 02
        /// </summary>
        ...
        /// <summary>
        /// Message to initiate connection request on destination TSAP 02 01
        /// </summary>
        /// <returns>IsoTCPMessage</returns>
        public IsoTcpMessage CreateCRConnectRequestThree()
        {
            var msg = new IsoTcpMessage(
                new TPKTHeader(0x3),
                new COTPMessage(
            ...
            msg.AddData((byte)0xc2, (byte)IsoTcpDataType.COTPData); // parameter code 2
            msg.AddData((byte)0x2, (byte)IsoTcpDataType.COTPData); // param length 2
            msg.AddData((UInt16)0x201, (byte)IsoTcpDataType.COTPData); // param data 2
        ...
        /// <summary>
        /// Message to initiate connection request on destination TSAP 03 02
        /// </summary>
        /// <returns>IsoTCPMessage</returns>
        public IsoTcpMessage CreateCRConnectRequestFour()
        {
            var msg = new IsoTcpMessage(
                new TPKTHeader(0x3),
                new COTPMessage(
            ...
            msg.AddData((byte)0xc2, (byte)IsoTcpDataType.COTPData); // parameter code 2
            msg.AddData((byte)0x2, (byte)IsoTcpDataType.COTPData); // param length 2
            msg.AddData((UInt16)0x302, (byte)IsoTcpDataType.COTPData); // param data 2
